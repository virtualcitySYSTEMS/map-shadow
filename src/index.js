    ...
    i18n: {
      en: {
        shadow: {
          ...
          units: 'units',
          toolState: {
            open: 'Simulate shadows',
            activate: 'Simulate shadows',
            deactivate: 'Simulate shadows',
          },
        },
      },
      de: {
        shadow: {
          ...
          units: 'Maßeinheiten',
          toolState: {
            open: 'Schatten simulieren',
            activate: 'Schatten simulieren',
            deactivate: 'Schatten simulieren',
          },
        },
      },
    },
